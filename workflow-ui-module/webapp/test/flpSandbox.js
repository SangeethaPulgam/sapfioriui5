		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#ui5fioritake3workflowuimodule-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ui5fioritake3workflowuimodule-display": {
								"semanticObject": "ui5fioritake3workflowuimodule",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ui5fioritake3.workflowuimodule",
									"url": sap.ui.require.toUrl("ui5fioritake3/workflowuimodule")
								}
							}
						}
					}
